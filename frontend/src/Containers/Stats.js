      ...
      </div>
      {
        ...
        <div className='flex flex-col items-center justify-center my-2 mx-4 gap-2'>
          <div className='text-center'>
            請先<Link to="https://myaccount.google.com/"><span className='text-blue-800 font-bold mx-1 hover:underline'>登入</span></Link>管理者 Google 帳號，再返回重新整理此頁面。<span className='text-neutral-500 mx-1 hover:underline' onClick={() => setShow(false)}>隱藏</span>
          </div>
        </div>
      }
